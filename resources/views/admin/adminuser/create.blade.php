                        ...
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/adminuser') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="email" placeholder="邮箱（将会作为登录名）" data-parsley-required="true" data-parsley-required-message="请输入邮箱" value="{{ old('email') }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="name">姓名 * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="name" placeholder="姓名" data-parsley-length="[2,20]" data-parsley-length-message="姓名长度2~20字符" data-parsley-required="true" data-parsley-required-message="请输入姓名" value="{{ old('name') }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="password">密码 * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" id="password" type="text" name="password" placeholder="密码" data-parsley-length="[6,12]" data-parsley-length-message="密码长度6~12字符" data-parsley-required="true" data-parsley-required-message="请输入密码" value="{{ old('password') }}"/>
                                </div>
                            </div>
                            <div class="form-group">
