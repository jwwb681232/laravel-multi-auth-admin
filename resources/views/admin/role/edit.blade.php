            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/role/'.$data['role']['id']) }}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2" for="name">角色 * :</label>
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="name" placeholder="角色" data-parsley-required="true" data-parsley-required-message="请输入角色名称（英文）" value="{{ $data['role']['name'] }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2" for="display_name">名称 * :</label>
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="display_name" placeholder="名称" data-parsley-required="true" data-parsley-required-message="请输入角色名称（中文）" value="{{ $data['role']['display_name'] }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2" for="description">描述 * :</label>
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="description" placeholder="描述" data-parsley-required="true" data-parsley-required-message="请输入角色描述" value="{{ $data['role']['description'] }}"/>
                                </div>
                            </div>
                            <div class="form-group">
